"""
Django settings for system_manager project.
...
env = environ.Env()
environ.Env.read_env(env.str('ENV_PATH', '.env'))  # Pass path explicitly
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=7),#minutes=30
